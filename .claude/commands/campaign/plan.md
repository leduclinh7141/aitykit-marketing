...
## Objective
Create a comprehensive marketing campaign plan based on the provided objective.
...
## Output
- Complete campaign plan in Markdown format
- Saved to `./plans/campaigns/[campaign-name]/`
