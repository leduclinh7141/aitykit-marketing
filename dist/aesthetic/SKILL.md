...
### Related Skills
- **ai-multimodal**: Analyze screenshots, generate design images, evaluate aesthetic quality using Gemini API
- **chrome-devtools**: Capture full-screen screenshots from inspiration websites
